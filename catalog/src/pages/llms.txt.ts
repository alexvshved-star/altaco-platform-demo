...
${BUSINESS.name} продає слеби натурального каменю (мармур, граніт, кварцит) та engineered-поверхні.
...
- Ціна (price_m2, price_slab) — орієнтовна, у євро, з ПДВ; розрахунок у гривні за курсом на день оплати. price_slab пораховано з площі слеба й округлено до 10 €.
